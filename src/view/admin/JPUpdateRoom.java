...
public class JPUpdateRoom extends JPanel {
    ...
    private JTextField jtfLarge = new JTextField();
    private JTextField jtfBed = new JTextField();
    private JTextField jtfPrice = new JTextField();
    private JLabel jlID = new JLabel("ID: ");
    private JLabel jlLarge = new JLabel("Large: ");
    private JLabel jlPrice = new JLabel("Price: ");
    private JLabel jlBed = new JLabel("Num of bed: ");
